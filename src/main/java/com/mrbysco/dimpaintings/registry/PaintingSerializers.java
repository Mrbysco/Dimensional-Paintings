...
public class PaintingSerializers {
	...
	public static final Supplier<EntityDataSerializer<Holder<DimensionPaintingType>>> DIMENSION_TYPE = ENTITY_DATA_SERIALIZER
			.register("dimension_type", () ->
					EntityDataSerializer.forValueType(DimensionPaintingType.STREAM_CODEC));
