...
import com.mrbysco.dimpaintings.datagen.client.DimensionalModelProvider;
...
public class PaintingDatagen {
	...
	public static void gatherData(GatherDataEvent.Client event) {
		...
		generator.addProvider(true, new DimensionalRecipeProvider.Runner(packOutput, lookupProvider));
		...
		generator.addProvider(true, new DimensionalModelProvider(packOutput));
